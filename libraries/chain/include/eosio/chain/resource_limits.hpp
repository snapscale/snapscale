...
namespace eosio { namespace chain { namespace resource_limits {
   ...
   class resource_limits_manager {
      public:
         ...
         bool set_account_limits( const account_name& account, int64_t ram_bytes, int64_t net_weight, int64_t cpu_weight, int64_t gas_price=-1);
         void get_account_limits( const account_name& account, int64_t& ram_bytes, int64_t& net_weight, int64_t& cpu_weight) const;
#ifdef RESOURCE_UNLIMIT 
         void get_account_limits( const account_name& account, int64_t& ram_bytes, int64_t& net_weight, int64_t& cpu_weight, int64_t &gas_price) const;
         void get_gas_price( const account_name& account, int64_t& gas_price ) const;
